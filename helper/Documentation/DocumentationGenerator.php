...
namespace MyParcelNL\Pdk\Helper\Documentation;
...
final class DocumentationGenerator extends AbstractHelperGenerator
{
    ...
    {
        $filename = sprintf('%s/docs/README.md', BASE_DIR);
    ...
    {
        /** @var \MyParcelNL\Pdk\Helper\Shared\Model\KeyValue $required */
    ...
    /**
     * @param  \MyParcelNL\Pdk\Helper\Shared\Model\KeyValue $required
     *
     * @return string
     */
