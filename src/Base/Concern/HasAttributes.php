...
trait HasAttributes
{
     ...
     */
    protected
    function addCastAttributesToArray(
        array $attributes,
     ...
     */
    protected
    function getAttributeFromArray(
        string $key
    ) {
     ...
     */
    protected
    function getClassCastableAttributeValue(
        string $key,
               $value
    ) {
     ...
     */
    protected
    function getMutatedAttributes(): array
    {
        $class = static::class;
