...
abstract class AbstractEndpoint
{
     ...
     */
    abstract protected function createVersionedRequest(Request $request, int $version): VersionedRequestInterface;

    /**
     * Create a versioned resource response based on API version.
     */
    abstract protected function createVersionedResourceResponse(array $data, int $version): VersionedResourceInterface;
