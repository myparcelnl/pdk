...
it('gets settings view', function (string $class, $output) {
    ...
    'carrierSettings'                => [
        ...
        'output' => [
            ...
            '8.type'        => 'ToggleInput',
            '9.name'        => CarrierSettings::CUTOFF_TIME,
            '9.label'       => 'Cutoff time',
            '9.type'        => 'TextInput',
            ...
            '12.label'      => 'Show delivery date',
            '12.type'       => 'ToggleInput',
            '13.name'       => CarrierSettings::PRICE_EVENING_DELIVERY,
            '13.label'      => 'Price evening delivery',
            '13.type'       => 'TextInput',
            '14.name'       => CarrierSettings::PRICE_MORNING_DELIVERY,
            '14.label'      => 'Price morning delivery',
            '14.type'       => 'TextInput',
            '15.name'       => CarrierSettings::PRICE_ONLY_RECIPIENT,
            '15.label'      => 'Price only recipient',
            '15.type'       => 'TextInput',
            '16.name'       => CarrierSettings::PRICE_PACKAGE_TYPE_DIGITAL_STAMP,
            '16.label'      => 'Price package type digital stamp',
            '16.type'       => 'TextInput',
            '17.name'       => CarrierSettings::PRICE_PACKAGE_TYPE_MAILBOX,
            '17.label'      => 'Price package type mailbox',
            '17.type'       => 'TextInput',
            '18.name'       => CarrierSettings::PRICE_PICKUP,
            '18.label'      => 'Price pickup',
            '18.type'       => 'TextInput',
            '19.name'       => CarrierSettings::PRICE_SAME_DAY_DELIVERY,
            '19.label'      => 'Price same day delivery',
            '19.type'       => 'TextInput',
            '20.name'       => CarrierSettings::PRICE_SIGNATURE,
            '20.label'      => 'Price signature',
            '20.type'       => 'TextInput',
            '21.name'       => CarrierSettings::PRICE_STANDARD_DELIVERY,
            '21.label'      => 'Price standard delivery',
            '21.type'       => 'TextInput',
            '22.name'       => CarrierSettings::DEFAULT_PACKAGE_TYPE,
            '22.label'      => 'Default package type',
            '22.type'       => 'SelectInput',
            '23.name'       => CarrierSettings::EXPORT_AGE_CHECK,
            '23.label'      => 'Age check 18+',
            '23.type'       => 'ToggleInput',
            '24.name'       => CarrierSettings::EXPORT_INSURED,
            '24.label'      => 'Insure shipment',
            '24.type'       => 'ToggleInput',
            '25.name'       => CarrierSettings::EXPORT_INSURED_AMOUNT,
            '25.label'      => 'Insure from price',
            '25.type'       => 'TextInput',
            '26.name'       => CarrierSettings::EXPORT_INSURED_AMOUNT_MAX,
            '26.label'      => 'Insure to maximum',
            '26.type'       => 'SelectInput',
            '27.name'       => CarrierSettings::EXPORT_INSURED_FOR_BE,
            '27.label'      => 'Insure shipments to Belgium',
            '27.type'       => 'ToggleInput',
            '28.name'       => CarrierSettings::EXPORT_EXTRA_LARGE_FORMAT,
            '28.label'      => 'Extra large package',
            '28.type'       => 'ToggleInput',
            '29.name'       => CarrierSettings::EXPORT_ONLY_RECIPIENT,
            '29.label'      => 'Only home address',
            '29.type'       => 'ToggleInput',
            '30.name'       => CarrierSettings::EXPORT_RETURN_SHIPMENTS,
            '30.label'      => 'Return when not delivered',
            '30.type'       => 'ToggleInput',
            '31.name'       => CarrierSettings::EXPORT_SIGNATURE,
            '31.label'      => 'Signature before delivery',
            '31.type'       => 'ToggleInput',
            '32.name'       => CarrierSettings::DIGITAL_STAMP_DEFAULT_WEIGHT,
            '32.label'      => 'Default weight digital stamp',
            '32.type'       => 'SelectInput',
        ],
    ],
    'orderSettings'                  => [
