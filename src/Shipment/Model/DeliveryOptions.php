...
class DeliveryOptions extends Model implements StorableArrayable
{
     ...
     * Attributes
     */
    final public const CARRIER          = 'carrier';
    final public const DATE             = 'date';
    final public const DELIVERY_TYPE    = 'deliveryType';
    final public const LABEL_AMOUNT     = 'labelAmount';
    final public const PACKAGE_TYPE     = 'packageType';
    final public const PICKUP_LOCATION  = 'pickupLocation';
    final public const SHIPMENT_OPTIONS = 'shipmentOptions';
    /**
     * Values
     */
    final public const DELIVERY_TYPE_MORNING_ID    = 1;
    final public const DELIVERY_TYPE_MORNING_NAME  = 'morning';
    final public const DELIVERY_TYPE_EVENING_ID    = 3;
    final public const DELIVERY_TYPE_EVENING_NAME  = 'evening';
    final public const DELIVERY_TYPE_STANDARD_ID   = 2;
    final public const DELIVERY_TYPE_STANDARD_NAME = 'standard';
    final public const DELIVERY_TYPE_PICKUP_ID     = 4;
    final public const DELIVERY_TYPE_PICKUP_NAME   = 'pickup';
    /**
     * @var int[]
     */
    final public const DELIVERY_TYPES_IDS = [
     ...
     * @var string[]
     */
    final public const DELIVERY_TYPES_NAMES = [
     ...
     * @var array
     */
    final public const DELIVERY_TYPES_NAMES_IDS_MAP = [
    ...
    final public const DEFAULT_DELIVERY_TYPE_ID     = self::DELIVERY_TYPE_STANDARD_ID;
    final public const DEFAULT_DELIVERY_TYPE_NAME   = self::DELIVERY_TYPE_STANDARD_NAME;
    /**
     * Package types
     */
    final public const  PACKAGE_TYPE_PACKAGE_ID         = 1;
    final public const  PACKAGE_TYPE_MAILBOX_ID         = 2;
    final public const  PACKAGE_TYPE_LETTER_ID          = 3;
    final public const  PACKAGE_TYPE_DIGITAL_STAMP_ID   = 4;
    final public const  PACKAGE_TYPE_PACKAGE_NAME       = 'package';
    final public const  PACKAGE_TYPE_MAILBOX_NAME       = 'mailbox';
    final public const  PACKAGE_TYPE_LETTER_NAME        = 'letter';
    final public const  PACKAGE_TYPE_DIGITAL_STAMP_NAME = 'digital_stamp';
    final public const  PACKAGE_TYPES_IDS               = [
        self::PACKAGE_TYPE_PACKAGE_ID,
        self::PACKAGE_TYPE_MAILBOX_ID,
        self::PACKAGE_TYPE_LETTER_ID,
        self::PACKAGE_TYPE_DIGITAL_STAMP_ID,
    ];
    final public const  PACKAGE_TYPES_NAMES             = [
    ...
    final public const  PACKAGE_TYPES_NAMES_IDS_MAP     = [
    ...
    final public const  DEFAULT_PACKAGE_TYPE_ID         = self::PACKAGE_TYPE_PACKAGE_ID;
    final public const  DEFAULT_PACKAGE_TYPE_NAME       = self::PACKAGE_TYPE_PACKAGE_NAME;
