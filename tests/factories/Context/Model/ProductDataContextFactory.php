 ...
 * @method $this withParent(PdkProduct|PdkProductFactory|PdkProductFactory $parent)
 * @method $this withPrice(Currency|CurrencyFactory|CurrencyFactory $price)
 * @method $this withSettings(ProductSettings|ProductSettingsFactory|ProductSettingsFactory $settings)
