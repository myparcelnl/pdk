...
class WebhookSubscription extends Model
{
     ...
     */
    final public const SHIPMENT_STATUS_CHANGE = 'shipment_status_change';
    /**
     * Called when a shipment label is created.
     */
    final public const SHIPMENT_LABEL_CREATED = 'shipment_label_created';
    /**
     * Called when an order status changes.
     */
    final public const ORDER_STATUS_CHANGE = 'order_status_change';
    /**
     * Called when the shop is updated.
     */
    final public const SHOP_UPDATED = 'shop_updated';
    /**
     * Called when the carrier accessibility is updated, e.g. when a carrier is enabled or disabled.
     */
    final public const SHOP_CARRIER_ACCESSIBILITY_UPDATED = 'shop_carrier_accessibility_updated';
    /**
     * Called when the carrier configuration is updated, e.g. when a carrier's settings are changed.
     */
    final public const SHOP_CARRIER_CONFIGURATION_UPDATED = 'shop_carrier_configuration_updated';
    /**
     * Called when a subscription is created or updated.
     */
    final public const SUBSCRIPTION_CREATED_OR_UPDATED = 'subscription_created_or_updated';
    /**
     * All possible hooks.
     */
