...
it('creates a valid request from an order collection', function (array $input, array $output) {
    ...
    'order containing many attributes' => [
        ...
        'output' => [
            ...
            '0.orderLines.price'                                          => 250,
            '0.orderLines.priceAfterVat'                                  => 260,
            '0.orderLines.product.description'                            => 'Een paars object waarmee stof opgezogen kan worden',
            '0.orderLines.product.ean'                                    => '018234',
            '0.orderLines.product.externalIdentifier'                     => '018234',
            '0.orderLines.product.height'                                 => null,
            '0.orderLines.product.length'                                 => null,
            '0.orderLines.product.name'                                   => 'Paarse stofzuiger',
            '0.orderLines.product.sku'                                    => '018234',
            '0.orderLines.product.uuid'                                   => '12345',
            '0.orderLines.product.weight'                                 => 3500,
            '0.orderLines.product.width'                                  => null,
            '0.orderLines.quantity'                                       => 1,
            '0.orderLines.uuid'                                           => '1234',
            '0.orderLines.vat'                                            => 10,
            '0.price'                                                     => 260,
